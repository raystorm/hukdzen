...
const BoxUserSlice = createSlice({
   ...
   reducers: {
      ...
      createBoxUser: (state, action: PayloadAction<BoxUser>) => { state.error = null; },
      ...
      updateBoxUser: (state, action: PayloadAction<BoxUser>) => { state.error = null; },
      ...
      updateBoxUserFailure: (state, action: PayloadAction<string>) =>
                            { state.error = action.payload; },
      removeBoxUser: (state, action: PayloadAction<BoxUser>) => { state.error = null; },
