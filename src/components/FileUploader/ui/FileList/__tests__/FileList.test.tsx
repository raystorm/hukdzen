...
describe('FileList', () => {
  ...
  it('renders as expected', () => {
    ...
    expect(
      container.getElementsByClassName(`${ComponentClassName.FileUploaderFileList}`)
    ).toHaveLength(1);
  ...
  it('renders as expected when upload is resumable', () => {
    ...
    expect(getByText(defaultFileUploaderDisplayText.pauseButtonText))
      .toBeInTheDocument();
  });
  ...
  it('should call onPause when pause button is clicked', () => {
    ...
    const pauseButton = getByText(defaultFileUploaderDisplayText.pauseButtonText);
