...
describe('getInput', () => {
  ...
  it('resolves an UploadDataWithPathInput with a callback `path` as expected',
     async () =>
  {
    const expected: UploadDataWithPathInput = {
      data: file,
  ...
  it('resolves an UploadDataInput without a `path` as expected',
     async () =>
  {
  ...
  it('resolves an UploadDataInput with a `path` as expected',
     async () =>
  {
    const expected: UploadDataInput = {
      data: file,
  ...
  it('includes additional values returned from `processFile` in `options`',
     async () =>
  {
    ...
    expect(output.options?.contentDisposition).toStrictEqual(contentDisposition);
  });

  it('defaults `options.contentType` to "binary/octet-stream" when no file type is provided',
     async () =>
  {
