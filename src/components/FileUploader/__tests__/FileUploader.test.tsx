...
describe('FileUploader', () => {
  ...
  it('behaves as expected with an accessLevel prop', () => {
    ...
    expect(
      container.getElementsByClassName(`${ComponentClassName.FileUploaderDropZone}`)
    ).toHaveLength(1);

    expect(
      container.getElementsByClassName(`${ComponentClassName.FileUploaderDropZoneText}`)
    ).toHaveLength(1);

    expect(
      container.getElementsByClassName(`${ComponentClassName.FileUploaderDropZoneIcon}`)
    ).toHaveLength(1);

    expect(
      container.getElementsByClassName(`${ComponentClassName.FileUploaderFilePicker}`)
    ).toHaveLength(1);

    expect(getByText(defaultFileUploaderDisplayText.browseFilesText)).toBeVisible();
    expect(getByText(defaultFileUploaderDisplayText.dropFilesText)).toBeVisible();
  ...
  it('renders as expected with autoUpload turned off', () => {
    ...
    expect(getByText(defaultFileUploaderDisplayText.clearAllButtonText)).toBeVisible();
    expect(getByText(defaultFileUploaderDisplayText.getSelectedFilesText(1))).toBeVisible();
  });
  ...
  it('renders as expected with override display text', () => {
    ...
    expect(getByText('Drag and drop files here, or click to select files')).toBeVisible();
  ...
  it('displays error message when file exceeds max file size', () => {
    ...
    expect(getByText(defaultFileUploaderDisplayText.getFileSizeErrorText('0 B'))).toBeVisible();
  });
  ...
  it('displays error message when max file count is exceeded', () => {
    ...
    expect(
      getByText(defaultFileUploaderDisplayText.getMaxFilesErrorText(maxFileCount))
    ).toBeVisible();
  });
  ...
  //'useDeprecationWarning() code removed'
  it.skip('logs a warning if provided an accessLevel prop', () => {
