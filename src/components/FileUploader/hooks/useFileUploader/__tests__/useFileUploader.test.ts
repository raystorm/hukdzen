...
describe('useUploadFiles', () => {
  ...
  it('should set upload progress', () => {
    ...
    act(() => result.current.setUploadProgress({ id: 'file1', progress: 50, }) );
  ...
  it('should set upload paused', () => {
    ...
    act(() => result.current.setUploadPaused({ id: 'file1', }));
  ...
  it('should set upload resumed', () => {
    ...
    act(() => result.current.setUploadResumed({ id: 'file1', }));
  ...
  it('should remove upload', () => {
    ...
    expect(result.current.files.length).toBe(2);
    act(() => result.current.removeUpload({ id: 'file1', }));
    expect(result.current.files.length).toBe(1);
  });

  describe('defaultFiles', () => {
    it('should handle good defaultFiles', () => {
      const { result } = renderHook(() => useFileUploader([{ key: 'file.jpg' }]));
