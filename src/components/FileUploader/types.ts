...
import { DropZoneProps } from './ui/DropZone/types';
import { FileListProps } from './ui/FileList/types';
import { FileListHeaderProps } from './ui/FileListHeader';
import { FileListFooterProps } from './ui/FileListFooter';
import { FilePickerProps, } from './ui/FilePicker';
import { FileUploaderDisplayText } from './utils/displayText';
import { PathCallback, UploadTask } from './utils/uploadFile';
...
export interface StorageFile {
  ...
  status: FileStatus;
  progress: number;
  // only present after an upload completes
  resolvedKey?: string;
...
export interface FileUploaderHandle { clearFiles: () => void; }
