import { Content, Summary, SummaryInput } from '../graphql/API';
...
export type { Content, Summary, SummaryInput };
                             ...
                             description?: string | null): Summary | null =>
{
   ...
   return { __typename: 'Summary', ...buildSummaryInput(title, description) };
}

/**
 *  Helper to build SummaryInput objects
 *  @param title
 *  @param description
 */
export const buildSummaryInput = (title?: string | null,
                                  description?: string | null): SummaryInput | null =>
{
   if ( !title && !description ) { return null; }
