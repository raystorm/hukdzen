...
import { request, response } from '../createUserGuarded.js';

describe('createUserGuarded', () =>
{
   ...
   describe('request', () =>
   {
      ...
      {
         const ctx = { arguments: { input: { email: 'test@example.com' } } };
         ...
         const ctx = {
            arguments: {
               input: {
                  ...
                  waa: 'Waa Name',
                  isAdmin: false,
                  emailPreferences: { allOptOut: false }
               }
            }
         };
      ...
      it('uses provided id when present', () =>
      {
         const ctx = {
            arguments: {
               input: { id: 'custom-id', name: 'Jane Doe', email: 'jane@example.com' }
            }
         };
